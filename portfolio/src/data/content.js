export const Content = [
    {
      ...
      name: "I am Aditi",
      excerpt: ` a BTech Computer Science student at BIT Mesra with a passion for web development, especially in the MERN stack. I love creating and collaborating on projects, embracing new challenges along the way. My diverse schooling across India has helped me adapt and broaden my perspective. I'm eager to work with others to craft engaging web experiences.`
    },
    {
      category: "about",
      link: `${window.location.origin}/about#skills`,
      name: "An overview of my technical skills and interests",
      excerpt: `Java , JavaScript , C,HTML, CSS, Bootstrap, Tailwind CSS, React, Node.js, Express.js, MongoDB, SQL,Git, GitHub, Postman`
    },
    {
      category: "works",
